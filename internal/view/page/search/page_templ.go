	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(results) == 0 {
			...
			for _, result := range results {
				...
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "\" alt=\"Crown cap\" class=\"h-full w-full object-cover\" loading=\"lazy\"></div><div class=\"absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/60 to-transparent p-2\"><span class=\"text-xs font-semibold text-white sm:text-sm\">")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
